...
input_str = """Sue 1: goldfish: 6, trees: 9, akitas: 0
...
def make_sue(stat1, val1, stat2, val2, stat3, val3):
  return {
    stat1: val1,
    stat2: val2,
    stat3: val3
...
for sue in sue_list:
  ...
  stat3 = s(info[6])
  val3 = i(info[7])
  sues[sue_num] = make_sue(stat1, val1, stat2, val2, stat3, val3)

for sue in sues:
  if test_sue(sues[sue]):
    print sue
