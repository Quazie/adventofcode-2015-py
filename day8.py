...
for string in strings:
  mem_count += len(string)
  char_count += len(eval(string))
  new_char_count += len(string) + 2
  for c in string:
    if c == '"':
      new_char_count += 1
    if c == '\\':
...
print "Original string contains {0} chars".format(char_count)
print "Original string takes up {0} memory".format(mem_count)
print "Original answer is {0}".format(mem_count-char_count)
print "New string is {0} in size".format(new_char_count)
print "New answer is {0}".format(new_char_count-mem_count)
